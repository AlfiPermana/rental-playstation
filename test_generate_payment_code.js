...
async function testGeneratePaymentCode() {
    let connection;
    ...
    try {
        ...
        const insertParams = [
            ...
            'Test Generate Payment Code', // customer_name
            'test@example.com', // customer_email
            '08123456760', // customer_phone
