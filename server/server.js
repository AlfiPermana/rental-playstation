...
// Set default APP_URL jika tidak ada
...
// Endpoint untuk booking public (tanpa login)
app.get('/booking', (req, res) => {
    res.sendFile(path.join(__dirname, '../public/booking.html'));
});

// Endpoint untuk tracking booking
app.get('/tracking', (req, res) => {
    res.sendFile(path.join(__dirname, '../public/tracking.html'));
});

// Endpoint untuk payment (tanpa login)
...
app.use('/api/guest', guestRoutes); // Guest routes (tanpa authentication)
